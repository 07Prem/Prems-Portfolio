...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "premjoshi1221@gmail",
    href: "premjoshi1221@gmail.com",
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Innovative App & Web Developer with a strong passion for Video & Photo Editing. Experienced in designing 
              and developing user-friendly applications while also creating visually compelling content. Committed to 
              blending technology with creativity to deliver impactful digital experiences. Always eager to learn, 
              adapt, and push the boundaries of design and development.
